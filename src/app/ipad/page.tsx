...
const features = [
  { title: "iPadOS + Apps", subtitle: "Flexible windowing. A multitasker's delight." },
  { title: "Productivity", subtitle: "Your workplace can be any place." },
  { title: "Creativity", subtitle: "Take your inner artist out and about." },
  { title: "Learning", subtitle: "Your classroom can be anywhere." },
  { title: "Entertainment", subtitle: "Kick back. Tune in. Game on." },
  { title: "Apple Pencil", subtitle: "Dream it up. Jot it down." },
  { title: "Apple Intelligence", subtitle: "Effortlessly helpful every day." },
];
...
const ecosystem = [
  ...
  {
    title: "iPad and Mac",
    description: "iPad and Mac are designed to work together to form the ultimate creative setup. Sketch on your iPad and have it appear instantly on your Mac with Sidecar. Universal Control allows you to use one mouse or trackpad seamlessly across both devices.",
  },
  {
